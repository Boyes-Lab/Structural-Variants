...
def get_matched_randomseqs(datasource, lengths):
...
def main():
    ...
    for datasource in sources:
        ...
        realneardict = get_real_svs(datasource)
        randomneardict = get_matched_randomseqs(datasource, lengths)
